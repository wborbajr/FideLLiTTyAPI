...
@router.get(
    "/articles", response_model=ManyArticlesInResponse, tags=["articles"]
)
...
@router.get(
    "/articles/feed", response_model=ManyArticlesInResponse, tags=["articles"]
)
...
@router.get(
    "/articles/{slug}", response_model=ArticleInResponse, tags=["articles"]
)
...
@router.delete(
    "/articles/{slug}", tags=["articles"], status_code=HTTP_204_NO_CONTENT
)
